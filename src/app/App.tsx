...
const BASE_WORKERS: Omit<Worker, 'available'>[] = [
  { id: 'w1', name: 'Maria Huber', baseAvailable: true, skills: ['window', 'general'], languages: ['DE', 'EN'], isSupervisor: true, reliability: 5, pastCustomers: ['Raiffeisen Bank AG', 'Schulgebäude BRG 6'], avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=150&h=150&fit=crop', totalJobs: 142, rating: 4.9, synergyWith: ['w3', 'w5', 'w9'], conflictsWith: ['w4', 'w8'] },
  { id: 'w2', name: 'Tomasz Kowalski', baseAvailable: true, skills: ['snow', 'general'], languages: ['PL', 'EN'], isSupervisor: false, reliability: 4, pastCustomers: ['Billa Markt Ottakring', 'Bürokomplex Euro Plaza'], avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop', totalJobs: 89, rating: 4.7, synergyWith: ['w7', 'w11'], conflictsWith: ['w6'] },
  { id: 'w3', name: 'Ana Popescu', baseAvailable: true, skills: ['window', 'special'], languages: ['DE', 'RO'], isSupervisor: true, reliability: 5, pastCustomers: ['Raiffeisen Bank AG', 'Privat: Familie Berger'], avatar: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=150&h=150&fit=crop', totalJobs: 115, rating: 4.8, synergyWith: ['w1', 'w5'], conflictsWith: [] },
  { id: 'w4', name: 'Ibrahim Al-Hassan', baseAvailable: false, skills: ['general'], languages: ['AR', 'EN'], isSupervisor: false, reliability: 3, pastCustomers: [], avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&h=150&fit=crop', totalJobs: 34, rating: 4.2, synergyWith: ['w7'], conflictsWith: ['w1'] },
  { id: 'w5', name: 'Elena Müller', baseAvailable: true, skills: ['general', 'special'], languages: ['DE'], isSupervisor: false, reliability: 5, pastCustomers: ['Raiffeisen Bank AG', 'Bürokomplex Euro Plaza'], avatar: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=150&h=150&fit=crop', totalJobs: 67, rating: 4.6, synergyWith: ['w1', 'w3'], conflictsWith: [] },
  { id: 'w6', name: 'Bogdan Ionescu', baseAvailable: true, skills: ['window', 'snow'], languages: ['RO', 'IT'], isSupervisor: false, reliability: 4, pastCustomers: ['Hotel Erzherzog Johann'], avatar: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=150&h=150&fit=crop', totalJobs: 92, rating: 4.5, synergyWith: ['w8', 'w10'], conflictsWith: ['w2'] },
  { id: 'w7', name: 'Fatima Yilmaz', baseAvailable: true, skills: ['general', 'machine'], languages: ['TR', 'EN'], isSupervisor: false, reliability: 4, pastCustomers: ['Billa Markt Ottakring', 'Bürokomplex Euro Plaza'], avatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&h=150&fit=crop', totalJobs: 78, rating: 4.7, synergyWith: ['w2', 'w4'], conflictsWith: [] },
  { id: 'w8', name: 'Goran Petrić', baseAvailable: true, skills: ['snow', 'special'], languages: ['HR', 'DE'], isSupervisor: false, reliability: 3, pastCustomers: [], avatar: 'https://images.unsplash.com/photo-1501196354995-cbb51c65aaea?w=150&h=150&fit=crop', totalJobs: 45, rating: 4.3, synergyWith: ['w6'], conflictsWith: ['w1'] },
  { id: 'w9', name: 'Karl Weber', baseAvailable: true, skills: ['general', 'window'], languages: ['DE'], isSupervisor: true, reliability: 5, pastCustomers: ['Hotel Erzherzog Johann', 'Ärztezentrum Wien Mitte'], avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop', totalJobs: 156, rating: 4.9, synergyWith: ['w1', 'w12'], conflictsWith: [] },
  { id: 'w10', name: 'Luka Novak', baseAvailable: true, skills: ['special', 'machine'], languages: ['SL', 'EN'], isSupervisor: false, reliability: 4, pastCustomers: ['Schulgebäude BRG 6'], avatar: 'https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?w=150&h=150&fit=crop', totalJobs: 56, rating: 4.4, synergyWith: ['w6'], conflictsWith: [] },
  { id: 'w11', name: 'Sven Larsson', baseAvailable: true, skills: ['general', 'snow'], languages: ['SV', 'EN'], isSupervisor: false, reliability: 5, pastCustomers: ['Bürokomplex Euro Plaza'], avatar: 'https://images.unsplash.com/photo-1552374196-c4e7ffc6e126?w=150&h=150&fit=crop', totalJobs: 82, rating: 4.8, synergyWith: ['w2'], conflictsWith: [] },
  { id: 'w12', name: 'Marek Nowak', baseAvailable: true, skills: ['window', 'general'], languages: ['DE', 'PL'], isSupervisor: false, reliability: 4, pastCustomers: ['Hotel Erzherzog Johann', 'Ärztezentrum Wien Mitte'], avatar: 'https://images.unsplash.com/photo-1560250097-0b93528c311a?w=150&h=150&fit=crop', totalJobs: 94, rating: 4.6, synergyWith: ['w9'], conflictsWith: [] },
];
